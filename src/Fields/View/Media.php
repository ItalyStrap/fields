...
class Media extends Input {
	...
	protected function maybe_render( array $attr ) {
        ...
        <div class="media_carousel_sortable">
            <ul id="sortable" class="carousel_images" style="text-align:center">
				<?php echo $this->list_elements( $values ); ?>
            </ul>
        </div>
	...
	protected function get_list_element( $id ) {
		...
		return '<li class="carousel-image ui-state-default"><div><i class="dashicons dashicons-no"></i>' . $html . '</div></li>'; // XSS ok.
	}
...
//		}
	...
	private function style() {
		...
		?><style scoped>
            ...
            .media_carousel_sortable ul {
                list-style-type: none;
                min-height: 155px;
                overflow: hidden;
            }
            .media_carousel_sortable ul:after {
                clear: both;
                content: "";
                display: block;
            }
            .media_carousel_sortable li {
                margin: 3px 3px 3px 0;
                padding: 1px;
                float: left;
            }
            .media_carousel_sortable li div {
                position: relative;
            }
            .media_carousel_sortable li div img:hover {
                opacity: 0.5;
            }
            .media_carousel_sortable li div .dashicons-no {
                color: transparent;
                font-size: 20px;
                position: absolute;
                top: 10px;
